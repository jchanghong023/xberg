...
:::
    ...
    - ✅ Text extraction (PDF, Office, images, 110 formats)
    - ✅ OCR with Tesseract
...
```bash title="Terminal"
# French OCR with Tesseract
xberg extract --ocr true --ocr-backend tesseract --ocr-language fra document.pdf
...
xberg extract --ocr true --ocr-backend tesseract --ocr-language deu document.pdf
...
| Flag                              | Description                                                                                                                  |
| --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `--ocr <true\|false>`             | Enable or disable OCR. The backend defaults to `paddle-ocr` wherever it is compiled in (all default CLI builds) and to `tesseract` otherwise; override with `--ocr-backend`. |
