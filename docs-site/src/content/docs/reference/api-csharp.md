...
<!-- alef:hash:06e0a1d15022a522c198279b7a086916506ee62f879bb6b97039d0e77499c474 -->
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `PdfVersion`: `string`, `Producer`: `string`, `IsEncrypted`: `bool`, `Width`: `long`, `Height`: `long`, `PageCount`: `uint`, `ScannedConfidence`: `float`, `ScannedPages`: `List<uint>`, `FabricatedTextPages`: `List<uint>`, `LayoutGatedPages`: `List<uint>`, `LayoutGateReasons`: `List<string>` |
