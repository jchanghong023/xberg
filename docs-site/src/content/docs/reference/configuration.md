...
<!-- alef:hash:ab628eb685abf2d6ba60f97db9de9e2523f032df27db9541fe0feb79dd08e91f -->
...
| Variant | Wire value | Description |
|---------|------------|-------------|
| `Pdf` | `pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdf_version`: `String`, `producer`: `String`, `is_encrypted`: `bool`, `width`: `i64`, `height`: `i64`, `page_count`: `u32`, `scanned_confidence`: `f32`, `scanned_pages`: `Vec<u32>`, `fabricated_text_pages`: `Vec<u32>`, `layout_gated_pages`: `Vec<u32>`, `layout_gate_reasons`: `Vec<String>` |
