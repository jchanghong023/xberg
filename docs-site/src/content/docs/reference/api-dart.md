...
<!-- alef:hash:bc16a814f8e12d83c719f87fc73c419cbe37a077a8e32974e7a261f8f0a691ce -->
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdfVersion`: `String`, `producer`: `String`, `isEncrypted`: `bool`, `width`: `int`, `height`: `int`, `pageCount`: `int`, `scannedConfidence`: `double`, `scannedPages`: `List<int>`, `fabricatedTextPages`: `List<int>`, `layoutGatedPages`: `List<int>`, `layoutGateReasons`: `List<String>` |
