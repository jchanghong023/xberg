...
<!-- alef:hash:2dd3bb23da8b71156290e5c0e485c0c94b515683be884216ab79ae941e4e1976 -->
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `PdfVersion`: `string`, `Producer`: `string`, `IsEncrypted`: `bool`, `Width`: `int64`, `Height`: `int64`, `PageCount`: `uint32`, `ScannedConfidence`: `float32`, `ScannedPages`: `[]uint32`, `FabricatedTextPages`: `[]uint32`, `LayoutGatedPages`: `[]uint32`, `LayoutGateReasons`: `[]string` |
