...
<!-- alef:hash:8153bafc3190f2d44cf730bc0c8dc4e4d766cba377cf38e5a385fc95b3171a04 -->
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdfVersion`: `String`, `producer`: `String`, `isEncrypted`: `Bool`, `width`: `Int64`, `height`: `Int64`, `pageCount`: `UInt32`, `scannedConfidence`: `Float`, `scannedPages`: `[UInt32]`, `fabricatedTextPages`: `[UInt32]`, `layoutGatedPages`: `[UInt32]`, `layoutGateReasons`: `[String]` |
