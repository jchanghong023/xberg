...
<!-- alef:hash:f5e5b7899909799656e85dbd700679900a3487c02f6608f5d06feb6544a2ea19 -->
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdfVersion`: `String`, `producer`: `String`, `isEncrypted`: `Boolean`, `width`: `Long`, `height`: `Long`, `pageCount`: `Int`, `scannedConfidence`: `Float`, `scannedPages`: `List<Int>`, `fabricatedTextPages`: `List<Int>`, `layoutGatedPages`: `List<Int>`, `layoutGateReasons`: `List<String>` |
