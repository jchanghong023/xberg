...
![Xberg features overview -- 106 input formats flow through extraction, OCR, and processing to produce text, tables, chunks, and metadata](../../assets/feature-overview.png)

---

## Format Support

107 file formats across 140 unique file extensions, with 53 compatibility MIME aliases, are handled by native Rust
