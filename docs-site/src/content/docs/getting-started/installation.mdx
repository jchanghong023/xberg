...
-  **Java**
  ...
  ***
  ...
  ```groovy
  implementation 'io.xberg:xberg:1.2.5'
  ```
...
-  **Kotlin Android**
  ...
  ***
  ...
  ```kotlin
  implementation("io.xberg:xberg-android:1.2.5")
  ```
...
-  **Swift**
  ...
  ***
  ...
  ```swift
  .package(url: "https://github.com/xberg-io/xberg.git", from: "1.2.5")
  ```
...
-  **Zig**
  ...
  ***
  ...
  ```bash
  zig fetch --save https://github.com/xberg-io/xberg/archive/refs/tags/v1.2.5.tar.gz
  ```
