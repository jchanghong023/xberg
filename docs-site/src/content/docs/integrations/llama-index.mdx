...
Xberg connects to [LlamaIndex](https://www.llamaindex.ai/) through a reader that turns any of 107 file
...
const reader = new XbergReader({
  extractionConfig: { chunking: { maxCharacters: 1000, overlap: 200 } },
});
const documents = await reader.loadData("report.pdf");
