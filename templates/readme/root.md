...
**109 formats · 144 file extensions** · **371 code languages** · **15 language bindings** · **6 output formats** · OCR · transcription · embeddings
...
|---|---|
| **109 document formats** | PDFs, Office, images, HTML, email, e-books, scientific publications, and structured data across 144 file extensions, with intelligent MIME detection and bounded extraction controls. |
