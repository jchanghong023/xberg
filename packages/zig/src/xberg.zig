...
// alef:hash:e165acd5fd1c66dd3200fe5efad8d99f3414285dfc85ba0bba34f63744f74702
// alef:handle-abi:1
...
pub const PdfMetadata = struct {
    ...
    ///
    /// `null` when `OcrQualityThresholds.enable_provenance_ocr_routing` is `false` or the
