...
<!-- alef:hash:db1bc1e066b688a291cf7a448c2aadfcd66184c0d6844349c19dca17d637409f -->
...
Extract text, tables, images, metadata, and code intelligence from 106 file formats and 371 programming languages including PDF, Office documents, images, and audio/video transcripts where native transcription is available. Zig bindings consuming the C FFI surface via @cImport, idiomatic error sets, optional types, and slice-based memory management.
