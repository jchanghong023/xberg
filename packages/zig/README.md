...
<!-- alef:hash:ac23d4f0092dd1e47bd1261083327bdc84274b6d9dd17446a8493547154892d3 -->
...
```bash
zig fetch --save https://github.com/xberg-io/xberg/archive/refs/tags/v1.2.6.tar.gz
```
