...
<!-- alef:hash:4824b95a32b1c56b4663f8f1a075bbadd32e913085efdb7ee0e6549fd04260ea -->
...
```bash
zig fetch --save https://github.com/xberg-io/xberg/archive/refs/tags/v1.2.8.tar.gz
```
