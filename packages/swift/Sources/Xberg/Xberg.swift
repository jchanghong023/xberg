...
// alef:hash:e496cf4199025536b73b092405b1504b9d7a088aba1a7c211217a0e645282c9c
...
public struct ImagePreprocessingConfig: Codable, Sendable, Hashable {
    ...
    public let normalizeShadedRows: Bool
    public init(targetDpi: Int32 = 300, autoRotate: Bool = false, deskew: Bool = true, denoise: Bool = false, contrastEnhance: Bool = false, binarizationMethod: String = "otsu", invertColors: Bool = false, normalizeShadedRows: Bool = false) {
        self.targetDpi = targetDpi
        ...
        self.normalizeShadedRows = normalizeShadedRows
    }
    private enum CodingKeys: String, CodingKey {
        case targetDpi = "target_dpi"
        ...
        case normalizeShadedRows = "normalize_shaded_rows"
    }
    public init(from decoder: any Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.targetDpi = try container.decodeIfPresent(Int32.self, forKey: .targetDpi) ?? 300
        ...
        self.normalizeShadedRows = try container.decodeIfPresent(Bool.self, forKey: .normalizeShadedRows) ?? false
    }
}
...
internal extension ImagePreprocessingConfig {
    init(_ rb: RustBridge.ImagePreprocessingConfigRef) throws {
        ...
        self.normalizeShadedRows = rb.normalizeShadedRows()
    }

    func intoRust() throws -> RustBridge.ImagePreprocessingConfig {
        return RustBridge.ImagePreprocessingConfig(self.targetDpi, self.autoRotate, self.deskew, self.denoise, self.contrastEnhance, RustString(self.binarizationMethod), self.invertColors, self.normalizeShadedRows)
    }
}
...
public struct TesseractConfig: Codable, Sendable, Hashable {
    ...
    public let thresholdingMethod: Int32
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.thresholdingMethod = try container.decodeIfPresent(Int32.self, forKey: .thresholdingMethod) ?? 0
    }
}
