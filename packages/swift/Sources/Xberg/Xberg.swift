...
// alef:hash:94819c01287cf5a380210e8f17f40d3829017102087dcedd99e8be659ecf64bd
...
public struct ServerConfig: Codable, Sendable, Hashable {
    ...
    public init(host: String = "127.0.0.1", port: UInt16 = 8000, corsOrigins: [String], maxRequestBodyBytes: UInt = 104857600, maxMultipartFieldBytes: UInt = 104857600) {
        self.host = host
        self.port = port
