...
// alef:hash:b6398c2803409d4a6af4812672da56141ca031c78e6a0ecf3073826eb598afad
...
public struct GridCell: Codable, Sendable, Hashable {
    ...
    public let bbox: BoundingBox?
    public init(content: String, row: UInt32, col: UInt32, rowSpan: UInt32 = 1, colSpan: UInt32 = 1, isHeader: Bool, bbox: BoundingBox? = nil) {
        self.content = content
        self.row = row
        self.col = col
...
public struct KeywordConfig: Codable, Sendable, Hashable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.ngramRange = try container.decode(NgramRange.self, forKey: .ngramRange)
...
public struct OcrQualityThresholds: Codable, Sendable, Hashable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.maxOcrOutputFragmentedWordRatio = try container.decode(Double.self, forKey: .maxOcrOutputFragmentedWordRatio)
        self.minOcrMeanConfidence = try container.decode(Double.self, forKey: .minOcrMeanConfidence)
        self.minWordsForOcrOutputCheck = try container.decode(UInt.self, forKey: .minWordsForOcrOutputCheck)
        self.maxOcrOutputDictInvalidWordRatio = try container.decode(Double.self, forKey: .maxOcrOutputDictInvalidWordRatio)
        ...
        self.minUndecodableRatio = try container.decode(Double.self, forKey: .minUndecodableRatio)
        self.enableProvenanceOcrRouting = try container.decode(Bool.self, forKey: .enableProvenanceOcrRouting)
        self.minProvenanceFallbackRatio = try container.decode(Double.self, forKey: .minProvenanceFallbackRatio)
    }
}
...
public struct PageContent: Codable, Sendable, Hashable {
    ...
    public init(pageNumber: UInt32, content: String, tables: [Table], imageIndices: [UInt32], imagePreprocessing: ImagePreprocessingMetadata? = nil, hierarchy: PageHierarchy? = nil, isBlank: Bool? = nil, layoutRegions: [LayoutRegion]? = nil, speakerNotes: String? = nil, sectionName: String? = nil, sheetName: String? = nil) {
        self.pageNumber = pageNumber
        self.content = content
        self.tables = tables
        self.imageIndices = imageIndices
...
public struct ServerConfig: Codable, Sendable, Hashable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.maxRequestBodyBytes = try container.decode(UInt.self, forKey: .maxRequestBodyBytes)
        self.maxMultipartFieldBytes = try container.decode(UInt.self, forKey: .maxMultipartFieldBytes)
    }
    // MARK: - Instance Methods
...
public struct SsrfPolicy: Codable, Sendable, Hashable {
    ...
    public init(denyPrivate: Bool = true, allowlist: [HostMatcher], maxRedirects: UInt8 = 5, schemeAllowlist: [String]) {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.schemeAllowlist = try container.decode([String].self, forKey: .schemeAllowlist)
    }
}
...
public struct TokenReductionOptions: Codable, Sendable, Hashable {
    ...
    public init(mode: String, preserveImportantWords: Bool = true) {
        self.mode = mode
