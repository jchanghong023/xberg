...
// alef:hash:ed80e6d439383f66eb59de907484dc82625b2dd8dc478679d03f7876dd6612fa
...
public struct PdfMetadata: Codable, Sendable, Hashable {
    ...
    public init(pdfVersion: String? = nil, producer: String? = nil, isEncrypted: Bool? = nil, width: Int64? = nil, height: Int64? = nil, pageCount: UInt32? = nil, scannedConfidence: Float? = nil, scannedPages: [UInt32]? = nil, fabricatedTextPages: [UInt32]? = nil, layoutGatedPages: [UInt32]? = nil, layoutGateReasons: [String]? = nil) {
