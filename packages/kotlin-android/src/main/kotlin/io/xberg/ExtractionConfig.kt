...
// alef:hash:bd0088da9cefca8fa43526af21a72cd1a2441248d826f54bd595c868bcbfd6e7
@file:Suppress(
...
data class ExtractionConfig(
    ...
    val mimeDetectionPolicy: MimeDetectionPolicy = MimeDetectionPolicy.PREFER_CONTENT,
     ...
     */
    val ocrNearEmptyFallback: Boolean? = null,
    /**
     ...
     */
    val ocrScannedPageQualityGate: Boolean? = null,
    /**
     ...
     */
    val ocrEmbeddedImages: Boolean? = null,
     ...
     */
    val extractionTimeoutSecs: Long? = 600L,
    /**
     ...
     */
    val maxEmbeddedFileBytes: Long? = 52428800L,
    /**
     ...
     */
    val applyNotebookCellTags: Boolean = true,
    /**
     ...
     */
    val geojson: GeoJsonExtractionConfig? = null,
    /**
     ...
     */
    val concurrency: ConcurrencyConfig? = null,
    /** URL ingestion and crawl configuration. */
    val url: UrlExtractionConfig,
    /**
     * Maximum recursion depth for archive extraction (default: 3).
     * Set to 0 to disable recursive extraction (legacy behavior).
     */
    val maxArchiveDepth: Long = 3L,
    /**
     ...
     * `null` derives it from whether an `ocr` block is present, which is what this
     ...
     */
    fun runsOcrOnEmbeddedImages(): Boolean {
        val selfJson = VALUE_METHOD_MAPPER.writeValueAsString(this)
        return XbergBridge.nativeExtractionConfigRunsOcrOnEmbeddedImages(selfJson)
    }
     ...
     * QR-code detection.
     */
    fun wantsOwnBytesInResult(): Boolean {
        val selfJson = VALUE_METHOD_MAPPER.writeValueAsString(this)
        return XbergBridge.nativeExtractionConfigWantsOwnBytesInResult(selfJson)
    }
