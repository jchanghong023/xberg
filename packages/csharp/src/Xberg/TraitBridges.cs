...
// alef:hash:8b3dd79a0d2984eadddff29a194658a92a151be1fd9537031cce0375c8b8143e
...
public sealed class OcrBackendBridge : IDisposable {
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate int ConfidenceSemanticsFn(IntPtr userData, out IntPtr outResult, out IntPtr outError);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate int PageOrientationHandlingFn(IntPtr userData, out IntPtr outResult, out IntPtr outError);
    ...
    private void BuildVtable() {
        ...
        _vtable = global::System.Runtime.InteropServices.Marshal.AllocHGlobal(IntPtr.Size * 17);
        ...
        var confidenceSemanticsFn = new ConfidenceSemanticsFn(ConfidenceSemanticsFnCallback);
        _delegateRoots.Add(confidenceSemanticsFn);
        global::System.Runtime.InteropServices.Marshal.WriteIntPtr(_vtable, 96, global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(confidenceSemanticsFn));

        // Slot 13: page_orientation_handling_fn
        var pageOrientationHandlingFn = new PageOrientationHandlingFn(PageOrientationHandlingFnCallback);
        _delegateRoots.Add(pageOrientationHandlingFn);
        global::System.Runtime.InteropServices.Marshal.WriteIntPtr(_vtable, 104, global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(pageOrientationHandlingFn));
        ...
        global::System.Runtime.InteropServices.Marshal.WriteIntPtr(_vtable, 112, global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(processDocumentFn));

        // Slot 15: free_string
        var freeStringFn = new FreeStringFn(FreeStringCallback);
        _delegateRoots.Add(freeStringFn);
        global::System.Runtime.InteropServices.Marshal.WriteIntPtr(_vtable, 120, global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(freeStringFn));

        // Slot 16: free_user_data
        var freeFn = new FreeUserDataFn(FreeUserDataCallback);
        _delegateRoots.Add(freeFn);
        global::System.Runtime.InteropServices.Marshal.WriteIntPtr(_vtable, 128, global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(freeFn));
    ...
    private int ConfidenceSemanticsFnCallback(IntPtr userData, out IntPtr outResult, out IntPtr outError) {
        OcrBackendBridge? _bridgeFromRegistry = null;
        lock (OcrBackendBridge._registryLock) {
            if (OcrBackendBridge._bridgeRegistry.TryGetValue(userData, out var bridgeFromRegistry)) {
                _bridgeFromRegistry = bridgeFromRegistry;
    ...
    private int PageOrientationHandlingFnCallback(IntPtr userData, out IntPtr outResult, out IntPtr outError) {
        OcrBackendBridge? _bridgeFromRegistry = null;
        lock (OcrBackendBridge._registryLock) {
            if (OcrBackendBridge._bridgeRegistry.TryGetValue(userData, out var bridgeFromRegistry)) {
                _bridgeFromRegistry = bridgeFromRegistry;
    ...
    public void Dispose() {
        lock (_registryLock) {
            if (!_nativeReleased && _bridgeRegistry.ContainsKey(_bridgeId)) return;
        }
        ReleaseResources();
    }
