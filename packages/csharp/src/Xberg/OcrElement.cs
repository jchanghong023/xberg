...
// alef:hash:75251e7670ee3a68a3317a6074d54f33e55c9cd4c0d268f87a244567ef65ccdc
...
public sealed record OcrElement
{
    ...
    public required OcrBoundingGeometry Geometry { get; init; }

    /// <summary>
    /// Confidence scores for detection and recognition.
    /// </summary>
    [JsonPropertyName("confidence")]
    public OcrConfidence Confidence { get; init; } = new OcrConfidence();

    /// <summary>
    /// Hierarchical level (word, line, block, page).
    /// </summary>
    [JsonPropertyName("level")]
    public OcrElementLevel Level { get; init; } = OcrElementLevel.Line;
