...
// alef:hash:7fa88e3dd09297c691362699954a94832d95626065620eb60cfb3cef0d850524
...
public sealed record PaddleOcrConfig
{
    ...
    public float DetDbThresh { get; init; } = 0.3f;
    ...
    public float DetDbBoxThresh { get; init; } = 0.5f;
    ...
    public float DetDbUnclipRatio { get; init; } = 1.6f;
    ...
    public uint DetLimitSideLen { get; init; } = 1024;
    ...
    public uint RecBatchNum { get; init; } = 6;
    ...
    public uint Padding { get; init; } = 10;
    ...
    public float DropScore { get; init; } = 0.5f;
    ...
    public string ModelTier { get; init; } = "mobile";
    ...
    public string ModelVersion { get; init; } = "pp-ocrv6";
    ...
    public PaddleOcrConfig WithTableDetection(bool enable)
    {
        ...
        try
        {
            var nativeResult = NativeMethods.PaddleOcrConfigWithTableDetection(selfHandle, (enable ? 1 : 0));
            var jsonPtr = NativeMethods.PaddleOcrConfigToJson(nativeResult);
            var json = global::System.Runtime.InteropServices.Marshal.PtrToStringUTF8(jsonPtr);
            NativeMethods.FreeString(jsonPtr);
            NativeMethods.PaddleOcrConfigFree(nativeResult);
    ...
    public PaddleOcrConfig WithAngleCls(bool enable)
    {
        ...
        try
        {
            var nativeResult = NativeMethods.PaddleOcrConfigWithAngleCls(selfHandle, (enable ? 1 : 0));
            var jsonPtr = NativeMethods.PaddleOcrConfigToJson(nativeResult);
            var json = global::System.Runtime.InteropServices.Marshal.PtrToStringUTF8(jsonPtr);
            NativeMethods.FreeString(jsonPtr);
            NativeMethods.PaddleOcrConfigFree(nativeResult);
