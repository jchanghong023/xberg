...
// alef:hash:49683486a37cdfd050d47e1f55901457e8488f414b7561842b1492b0e6940137
...
public sealed record GeoJsonExtractionConfig
{
    ...
    public static GeoJsonExtractionConfig FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<GeoJsonExtractionConfig>(json, JsonOptions)
                ?? throw new XbergException($"Failed to parse GeoJsonExtractionConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new XbergException($"Failed to parse GeoJsonExtractionConfig from JSON: {e.Message}", e);
        }
    }
