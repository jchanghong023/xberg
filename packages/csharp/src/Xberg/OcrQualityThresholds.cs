...
// alef:hash:95701d7d3d1f145f05f1b4a14b52e260a5316359d2ef2815f0e9e10ee15a483c
...
public sealed record OcrQualityThresholds
{
    ...
    public double MaxOcrOutputFragmentedWordRatio { get; init; } = 0.35;
    ...
    public double MinOcrMeanConfidence { get; init; } = 75.0;
    ...
    public ulong MinWordsForOcrOutputCheck { get; init; } = 20;
    ...
    public double MaxOcrOutputDictInvalidWordRatio { get; init; } = 1.01;
    ...
    public bool DiscardSuspectedOcrNoise { get; init; } = false;
    ...
    public double MinUndecodableRatio { get; init; } = 0.5;
    ...
    public bool EnableProvenanceOcrRouting { get; init; } = true;
    ...
    public double MinProvenanceFallbackRatio { get; init; } = 0.5;
    ...
    /// </summary>
    [JsonPropertyName("enable_plausibility_ocr_routing")]
    public bool EnablePlausibilityOcrRouting { get; init; } = true;
    ...
    /// </summary>
    [JsonPropertyName("min_reliable_language_chunk_ratio")]
    public double MinReliableLanguageChunkRatio { get; init; } = 0.1;
