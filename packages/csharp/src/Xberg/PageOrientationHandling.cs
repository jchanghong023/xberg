...
// alef:hash:2f4c0dd91993f5968df9821ec0825559be7c268a0767cbb5152502d1a160a308
#nullable enable
...
public enum PageOrientationHandling
{
    ...
    /// </summary>
    [JsonPropertyName("SelfCorrecting")]
    SelfCorrecting,
    /// <summary>
    /// Recognises rotated text correctly but emits blocks in raw raster order,
    /// so the caller must reorder.
    /// </summary>
    [JsonPropertyName("RecognisesRotatedText")]
    RecognisesRotatedText,
    /// <summary>
    /// Requires an upright raster; rotated text produces garbage.
    /// </summary>
    [JsonPropertyName("RequiresUpright")]
    RequiresUpright,
}


/// <summary>
/// Custom JSON converter for <see cref="PageOrientationHandling"/> that respects explicit variant names.
/// </summary>
internal sealed class PageOrientationHandlingJsonConverter : JsonConverter<PageOrientationHandling>
{
    public override PageOrientationHandling Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return value switch
        {
            ...
            _ => throw new JsonException($"Unknown PageOrientationHandling value: {value}")
        };
    }

    public override void Write(Utf8JsonWriter writer, PageOrientationHandling value, JsonSerializerOptions options)
    {
