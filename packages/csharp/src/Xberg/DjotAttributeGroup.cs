...
// alef:hash:a62bd4c9ac4bd3927ce5d6c397b615ec1fa6b90452f51fb62f1a94b62e6a7031
...
public sealed record DjotAttributeGroup
{
    ...
    public Attributes Attributes { get; init; } = new Attributes();
    ...
    public static DjotAttributeGroup FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<DjotAttributeGroup>(json, JsonOptions)
                ?? throw new XbergException($"Failed to parse DjotAttributeGroup from JSON: deserializer returned null");
        }
        ...
        {
            throw new XbergException($"Failed to parse DjotAttributeGroup from JSON: {e.Message}", e);
        }
    }
