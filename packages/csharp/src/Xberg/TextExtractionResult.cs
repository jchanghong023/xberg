...
// alef:hash:0e0d8a85c5513d472df0a844b95ca53d63191d601e208bcecaeb428e9485134b
...
public sealed record TextExtractionResult
{
    ...
    public List<MarkdownLink>? Links { get; init; } = null;

    /// <summary>
    /// Code blocks (Markdown files only).
    /// </summary>
    [JsonPropertyName("code_blocks")]
    public List<MarkdownCodeBlock>? CodeBlocks { get; init; } = null;
