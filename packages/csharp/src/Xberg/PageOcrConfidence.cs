...
// alef:hash:8ce55aff4bc9f8e90fa62b1ff1fb557ef034aa277365fabcf25efada7c311a6f
    ...
    public static PageOcrConfidence FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<PageOcrConfidence>(json, JsonOptions)
                ?? throw new XbergException($"Failed to parse PageOcrConfidence from JSON: deserializer returned null");
        }
        ...
        {
            throw new XbergException($"Failed to parse PageOcrConfidence from JSON: {e.Message}", e);
        }
    }
