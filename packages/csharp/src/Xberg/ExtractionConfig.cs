...
// alef:hash:67de516fb095cd720d832ab630be4dd7470f903330b6bd9ecad81afacbb30420
...
public sealed record ExtractionConfig
{
    ...
    public MimeDetectionPolicy MimeDetectionPolicy { get; init; } = MimeDetectionPolicy.PreferContent;
    ...
    /// </summary>
    [JsonPropertyName("ocr_near_empty_fallback")]
    public bool? OcrNearEmptyFallback { get; init; } = null;
    ...
    /// </summary>
    [JsonPropertyName("ocr_scanned_page_quality_gate")]
    public bool? OcrScannedPageQualityGate { get; init; } = null;
    ...
    /// </summary>
    [JsonPropertyName("ocr_embedded_images")]
    public bool? OcrEmbeddedImages { get; init; } = null;
    ...
    public ResultFormat ResultFormat { get; init; } = ResultFormat.Unified;
    ...
    public bool ApplyNotebookCellTags { get; init; } = true;
    ...
    public GeoJsonExtractionConfig? Geojson { get; init; } = null;
    ...
    public ConcurrencyConfig? Concurrency { get; init; } = null;

    /// <summary>
    /// URL ingestion and crawl configuration.
    /// </summary>
    [JsonPropertyName("url")]
    public UrlExtractionConfig Url { get; init; } = new UrlExtractionConfig();
    ...
    public ulong MaxArchiveDepth { get; init; } = 3;
