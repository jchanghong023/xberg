...
// alef:hash:0a8546e4fb16aba057cfac7518bf6475ae645ce72a75cc3baaf477354bcd1047
#nullable enable
...
public enum MimeDetectionPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("prefer_content")]
    PreferContent,
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("trust_extension")]
    TrustExtension,
    /// <summary>
    /// Ignore the filename extension and require content-based detection.
    /// </summary>
    [JsonPropertyName("content_only")]
    ContentOnly,
}


/// <summary>
/// Custom JSON converter for <see cref="MimeDetectionPolicy"/> that respects explicit variant names.
/// </summary>
internal sealed class MimeDetectionPolicyJsonConverter : JsonConverter<MimeDetectionPolicy>
{
    public override MimeDetectionPolicy Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return value switch
        {
            ...
            _ => throw new JsonException($"Unknown MimeDetectionPolicy value: {value}")
        };
    }

    public override void Write(Utf8JsonWriter writer, MimeDetectionPolicy value, JsonSerializerOptions options)
    {
