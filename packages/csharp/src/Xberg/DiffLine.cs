...
// alef:hash:8313bac8370100e3f3e5e4ce16f125da2276ad37588c1a7ba9562ab978eac0d9
...
/// </summary>
/// <remarks>
/// Handles serde's adjacently tagged layout: the discriminator under "kind" and the
/// whole payload — object or scalar — under "text". System.Text.Json's
/// [JsonPolymorphic] cannot express this layout, so we manually (de)serialize here.
/// </remarks>
public sealed class DiffLineJsonConverter : JsonConverter<DiffLine>
{
    public override DiffLine Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        // verbatim rather than reassembled from the sibling fields. Tuple-variant records
        // (`Variant(InnerStruct value)`) expect it under a single "Value" field; struct-variant
        // records (`Variant { field1, field2 }`) expect the payload object itself.
    ...
    public override void Write(Utf8JsonWriter writer, DiffLine value, JsonSerializerOptions options)
    {
        ...
        // is serde's *internal* form and Rust rejects it with "expected adjacently tagged enum";
        // it also has nothing to flatten when the payload is a scalar, which dropped it outright.
        string tag;
        object? inner;
        switch (value)
        {
