...
// alef:hash:ea542664d79d808e58e6abc62a427eaa8c32ddd39eb3fdb43dd5b8f39f434038
#nullable enable
...
/// <summary>
/// Custom JSON converter for <see cref="ConfidenceSemantics"/> that respects explicit variant names.
/// </summary>
internal sealed class ConfidenceSemanticsJsonConverter : JsonConverter<ConfidenceSemantics>
{
    public override ConfidenceSemantics Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        var value = reader.GetString();
        return value switch
        {
            "Legibility" => ConfidenceSemantics.Legibility,
            "Uncalibrated" => ConfidenceSemantics.Uncalibrated,
            "None" => ConfidenceSemantics.None,
            _ => throw new JsonException($"Unknown ConfidenceSemantics value: {value}")
        };
    }

    public override void Write(Utf8JsonWriter writer, ConfidenceSemantics value, JsonSerializerOptions options)
    {
        var str = value switch
        {
            ConfidenceSemantics.Legibility => "Legibility",
