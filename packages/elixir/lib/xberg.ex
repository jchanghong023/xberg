...
# alef:hash:43ed9062d0abb76237167d9c3f4062a0ae62873999c9a532ffbc65cf6d34987a
...
defmodule Xberg do
  ...
  @doc "List every registered OCR backend's name alongside its declared supported languages."
  @spec list_ocr_backend_capabilities() :: {:ok, [map()]} | {:error, atom, String.t()}
  def list_ocr_backend_capabilities do
    Xberg.Native.list_ocr_backend_capabilities()
  end
  ...
  @doc "Check whether a specific registered OCR backend supports a language."
  @spec ocr_backend_supports_language(String.t(), String.t()) ::
          {:ok, boolean()} | {:error, atom, String.t()}
  def ocr_backend_supports_language(backend, language) do
    Xberg.Native.ocr_backend_supports_language(backend, language)
  end
  ...
  def metaschema_parse_preset(obj, path, raw) do
    obj =
      case obj do
        ...
        %Xberg.MetaSchema{ref: reference} when is_reference(reference) -> reference
        _ -> raise ArgumentError, "receiver must be a reference or Xberg.MetaSchema wrapper"
      end
  ...
  def registry_get(obj, id) do
    obj =
      case obj do
        reference when is_reference(reference) -> reference
        %Xberg.Registry{ref: reference} when is_reference(reference) -> reference
        _ -> raise ArgumentError, "receiver must be a reference or Xberg.Registry wrapper"
      end
