...
// alef:hash:cf59e23493e8f26aeb7ba3fa239c4b62337eeca848b079ee2bb2c116eaeeb0f7
    ...
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            max_archive_depth: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or(xberg::ExtractionConfig::default_archive_depth()),
...
impl HtmlOutputConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            class_prefix: opts.get("class_prefix").and_then(|t| t.decode().ok()).unwrap_or(
                serde_json::from_str::<xberg::HtmlOutputConfig>(r#"{}"#)
                    .expect("alef-generated default JSON for `HtmlOutputConfig` failed to deserialize")
                    .class_prefix,
            ),
...
impl LateInteractionConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            model: opts.get("model").and_then(|t| t.decode().ok()).unwrap_or_default(),
            batch_size: opts.get("batch_size").and_then(|t| t.decode().ok()).unwrap_or(
                serde_json::from_str::<xberg::LateInteractionConfig>(r#"{}"#)
                    .expect("alef-generated default JSON for `LateInteractionConfig` failed to deserialize")
                    .batch_size,
            ),
            max_length: opts.get("max_length").and_then(|t| t.decode().ok()).unwrap_or(
                serde_json::from_str::<xberg::LateInteractionConfig>(r#"{}"#)
                    .expect("alef-generated default JSON for `LateInteractionConfig` failed to deserialize")
                    .max_length,
            ),
            query_max_length: opts.get("query_max_length").and_then(|t| t.decode().ok()).unwrap_or(
                serde_json::from_str::<xberg::LateInteractionConfig>(r#"{}"#)
                    .expect("alef-generated default JSON for `LateInteractionConfig` failed to deserialize")
                    .query_max_length,
            ),
...
impl OcrConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            enabled: opts.get("enabled").and_then(|t| t.decode().ok()).unwrap_or(true),
            backend: opts.get("backend").and_then(|t| t.decode().ok()).unwrap_or(
                serde_json::from_str::<xberg::OcrConfig>(r#"{}"#)
                    .expect("alef-generated default JSON for `OcrConfig` failed to deserialize")
                    .backend,
            ),
            language: opts
                .get("language")
    ...
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            max_ocr_output_fragmented_word_ratio: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or(
                    serde_json::from_str::<xberg::OcrQualityThresholds>(r#"{}"#)
                        .expect("alef-generated default JSON for `OcrQualityThresholds` failed to deserialize")
...
impl ServerConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            host: opts.get("host").and_then(|t| t.decode().ok()).unwrap_or(
                serde_json::from_str::<xberg::ServerConfig>(r#"{}"#)
                    .expect("alef-generated default JSON for `ServerConfig` failed to deserialize")
                    .host,
            ),
            port: opts.get("port").and_then(|t| t.decode().ok()).unwrap_or(
                serde_json::from_str::<xberg::ServerConfig>(r#"{}"#)
                    .expect("alef-generated default JSON for `ServerConfig` failed to deserialize")
                    .port,
            ),
...
impl SparseEmbeddingConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            model: opts.get("model").and_then(|t| t.decode().ok()).unwrap_or_default(),
            batch_size: opts.get("batch_size").and_then(|t| t.decode().ok()).unwrap_or(
                serde_json::from_str::<xberg::SparseEmbeddingConfig>(r#"{}"#)
                    .expect("alef-generated default JSON for `SparseEmbeddingConfig` failed to deserialize")
                    .batch_size,
            ),
            max_length: opts.get("max_length").and_then(|t| t.decode().ok()).unwrap_or(
                serde_json::from_str::<xberg::SparseEmbeddingConfig>(r#"{}"#)
...
impl SsrfPolicy {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            scheme_allowlist: opts.get("scheme_allowlist").and_then(|t| t.decode().ok()).unwrap_or(
...
impl TokenReductionOptions {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            mode: opts.get("mode").and_then(|t| t.decode().ok()).unwrap_or(
                serde_json::from_str::<xberg::TokenReductionOptions>(r#"{}"#)
                    .expect("alef-generated default JSON for `TokenReductionOptions` failed to deserialize")
                    .mode,
            ),
            preserve_important_words: opts
                .get("preserve_important_words")
...
#[rustler::nif]
pub fn pdfconfig_validate(obj: PdfConfig) -> Result<(), String> {
    let result = xberg::PdfConfig::from(obj).validate().map_err(|e| e.to_string())?;
    Ok(result)
}
