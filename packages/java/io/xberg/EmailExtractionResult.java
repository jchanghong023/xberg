...
// alef:hash:cc88b69111a3fec62b557d56efcdc8e6088277000c9074dca4aee7b081e3774a
...
public record EmailExtractionResult(
  ...
  public static final class Builder {
    ...
    @JsonProperty("from_email") @Nullable private String fromEmail;
    @JsonProperty("to_emails") private List<String> toEmails = List.of();
    @JsonProperty("cc_emails") private List<String> ccEmails = List.of();
    @JsonProperty("bcc_emails") private List<String> bccEmails = List.of();
    @Nullable private String date;
    @JsonProperty("message_id") @Nullable private String messageId;
    @JsonProperty("plain_text") @Nullable private String plainText;
    @JsonProperty("html_content") @Nullable private String htmlContent;
    ...
    /**
     * Constructs a EmailExtractionResult instance from the builder's current
     * state.
     */
    public EmailExtractionResult build() {
      return new EmailExtractionResult(
          subject, fromEmail, toEmails, ccEmails, bccEmails, date, messageId,
          plainText, htmlContent, content, attachments, metadata);
    }
  }
  // CPD-ON
}
