...
// alef:hash:39d00ae6703dee499cb134c84560bcfce467e9ea092252541e3ea33cb9801cad
...
public record Metadata(
    ...
    @JsonDeserialize(using = FormatMetadataDeserializer.class) @Nullable
    @JsonProperty("format") FormatMetadata format,
    @Nullable @JsonProperty("image_preprocessing")
  ...
  public static final class Builder {
    ...
    @JsonProperty("created_at") @Nullable private String createdAt;
    @JsonProperty("modified_at") @Nullable private String modifiedAt;
    @JsonProperty("created_by") @Nullable private String createdBy;
    @JsonProperty("modified_by") @Nullable private String modifiedBy;
    @Nullable private PageStructure pages;
    @Nullable private FormatMetadata format;
    @JsonProperty("image_preprocessing")
    @Nullable
    private ImagePreprocessingMetadata imagePreprocessing;
    @JsonProperty("json_schema") @Nullable private Object jsonSchema;
    ...
    @JsonProperty("document_version") @Nullable private String documentVersion;
    @JsonProperty("abstract_text") @Nullable private String abstractText;
    @JsonProperty("output_format") @Nullable private String outputFormat;
    @JsonProperty("ocr_used") @Nullable private Boolean ocrUsed;
    ...
    @JsonProperty("image_preprocessing")
    public Builder
    withImagePreprocessing(final @Nullable ImagePreprocessingMetadata value) {
    ...
    public Metadata build() {
      return new Metadata(title, subject, authors, keywords, language,
                          createdAt, modifiedAt, createdBy, modifiedBy, pages,
                          format, imagePreprocessing, jsonSchema, error,
                          extractionDurationMs, category, tags, documentVersion,
                          abstractText, outputFormat, ocrUsed, additional);
    }
  }
  // CPD-ON
}
