...
// alef:hash:464f613f17a67c79acc56eddeca14b2c1d2bf478c1a85216c5e6f2310a5b3882
...
public record HtmlMetadata(
    ...
    @Nullable @JsonProperty("structured_data")
  ...
  public static final class Builder {
    ...
    @JsonProperty("open_graph") @Nullable private Map<String, String> openGraph;
    @JsonProperty("twitter_card")
    @Nullable
    private Map<String, String> twitterCard;
    @JsonProperty("meta_tags") @Nullable private Map<String, String> metaTags;
    ...
    @JsonProperty("structured_data")
    public Builder withStructuredData(final
                                      @Nullable List<StructuredData> value) {
    ...
    public HtmlMetadata build() {
      return new HtmlMetadata(title, description, keywords, author,
                              canonicalUrl, baseHref, language, textDirection,
                              openGraph, twitterCard, metaTags, headers, links,
