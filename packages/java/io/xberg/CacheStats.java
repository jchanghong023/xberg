...
// alef:hash:0c3641ff381342dad29bceef99c3929628895aea92b71ccaebb8cc2f513515d6
...
public record
CacheStats(@JsonProperty("total_files") long totalFiles,
  ...
  public static final class Builder {
    ...
    @JsonProperty("total_files") private long totalFiles;
    @JsonProperty("total_size_mb") private double totalSizeMb;
    @JsonProperty("available_space_mb") private double availableSpaceMb;
    @JsonProperty("oldest_file_age_days") private double oldestFileAgeDays;
    @JsonProperty("newest_file_age_days") private double newestFileAgeDays;
    ...
    public CacheStats build() {
      return new CacheStats(totalFiles, totalSizeMb, availableSpaceMb,
                            oldestFileAgeDays, newestFileAgeDays);
    }
  }
  // CPD-ON
}
