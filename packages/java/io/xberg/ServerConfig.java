...
// alef:hash:0e4963ffd35424507a904d24712c5a8153f32326fe3c0dcf5e94e2ad96a9ac67
...
public record ServerConfig(
    ...
    @Nullable @JsonProperty("max_multipart_field_bytes")
    Long maxMultipartFieldBytes,
  ...
  public ServerConfig {
    ...
    if (maxRequestBodyBytes == null) {
      maxRequestBodyBytes = 104857600L;
    }
    if (maxMultipartFieldBytes == null) {
      maxMultipartFieldBytes = 104857600L;
    }
    if (jobTimeoutSecs == null) {
      jobTimeoutSecs = 600L;
    }
  }
  ...
  public static final class Builder {
    ...
    @JsonProperty("cors_origins") @Nullable private List<String> corsOrigins;
    @JsonProperty("max_request_body_bytes")
    @Nullable
    private Long maxRequestBodyBytes;
    @JsonProperty("max_multipart_field_bytes")
    @Nullable
    private Long maxMultipartFieldBytes;
    @JsonProperty("job_timeout_secs") @Nullable private Long jobTimeoutSecs;
    ...
    public ServerConfig build() {
      return new ServerConfig(host, port, corsOrigins, maxRequestBodyBytes,
                              maxMultipartFieldBytes, jobTimeoutSecs);
    }
  }
  // CPD-ON
}
