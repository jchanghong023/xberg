...
// alef:hash:4a1cdd5c49b397710b6c727a9ad00ecdf9c9c9b5c7992da5b3c9d633c1b53267
...
@JsonSubTypes({
  ...
  , @JsonSubTypes.Type(value = NodeContent.Heading.class, name = "heading"),
      @JsonSubTypes.Type(value = NodeContent.Paragraph.class,
                         name = "paragraph"),
      ...
      @JsonSubTypes.Type(value = NodeContent.PageBreak.class,
                         name = "page_break"),
      ...
      @JsonSubTypes.Type(value = NodeContent.Admonition.class,
                         name = "admonition"),
...
public sealed interface NodeContent {
   ...
   *
   * {@code heading_level} + {@code heading_text} capture the section heading
   * directly rather than relying on a first-child positional convention.
   */
   ...
   */
  record Citation(@JsonProperty("key") String key,
                  @JsonProperty("text") String text) implements NodeContent {}
  ...
  record MetadataBlock(@JsonProperty("entries")
                       java.util.List<KeyValueAttribute> entries)
      implements NodeContent {}
}
