...
// alef:hash:eb5330cef8bd1261c46123a9442e2236d9caf3973b442e5fe59649ce5906bbb7
 ...
 * - {@code Vec&lt;Arc&lt;ExtractedImage&gt;&gt;} enables zero-copy sharing of
 * image data
...
public record PageContent(
  ...
  public static final class Builder {
    ...
    @JsonProperty("is_blank") @Nullable private Boolean isBlank;
    @JsonProperty("layout_regions")
    @Nullable
    private List<LayoutRegion> layoutRegions;
    @JsonProperty("speaker_notes") @Nullable private String speakerNotes;
    @JsonProperty("section_name") @Nullable private String sectionName;
    @JsonProperty("sheet_name") @Nullable private String sheetName;
    @JsonProperty("ocr_confidence")
    @Nullable
    private PageOcrConfidence ocrConfidence;
    ...
    public PageContent build() {
      return new PageContent(pageNumber, content, tables, imageIndices,
                             imagePreprocessing, hierarchy, isBlank,
                             layoutRegions, speakerNotes, sectionName,
                             sheetName, ocrConfidence);
    }
  }
  // CPD-ON
}
