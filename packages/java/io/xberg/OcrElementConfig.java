...
// alef:hash:d168353add06956db57eaf3b8c6719bbb294ae0cb619642e9f8be236e9d7fa88
...
public record OcrElementConfig(
  ...
  public static final class Builder {
    ...
    @JsonProperty("include_elements") @Nullable private Boolean includeElements;
    @JsonProperty("min_level")
    @Nullable
    private OcrElementLevel minLevel = OcrElementLevel.LINE;
    @JsonProperty("min_confidence") @Nullable private Double minConfidence;
    @JsonProperty("build_hierarchy") @Nullable private Boolean buildHierarchy;
    ...
    public OcrElementConfig build() {
      return new OcrElementConfig(includeElements, minLevel, minConfidence,
                                  buildHierarchy);
    }
  }
  // CPD-ON
