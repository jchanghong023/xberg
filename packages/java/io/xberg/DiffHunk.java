...
// alef:hash:e080ea8adc78bf0bc93f9c0994b76800357830bb49e441443b2b6c6474131bac
...
public record DiffHunk(@JsonProperty("from_line") long fromLine,
  ...
  public static final class Builder {
    ...
    @JsonProperty("from_line") private long fromLine;
    @JsonProperty("from_count") private long fromCount;
    @JsonProperty("to_line") private long toLine;
    @JsonProperty("to_count") private long toCount;
    ...
    public DiffHunk build() {
      return new DiffHunk(fromLine, fromCount, toLine, toCount, lines);
    }
  }
  // CPD-ON
}
