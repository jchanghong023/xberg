...
// alef:hash:b0841f81ba353baac44b1d1153604d4a3728de0b62106e51145dc30a926404de
...
public record ChunkMetadata(
  ...
  public static final class Builder {
    ...
    @JsonProperty("byte_start") private long byteStart;
    @JsonProperty("byte_end") private long byteEnd;
    @JsonProperty("token_count") @Nullable private Long tokenCount;
    @JsonProperty("chunk_index") private long chunkIndex;
    @JsonProperty("total_chunks") private long totalChunks;
    @JsonProperty("first_page") @Nullable private Integer firstPage;
    @JsonProperty("last_page") @Nullable private Integer lastPage;
    ...
    @Nullable
    private List<PageSpan> pageSpans = List.of();
    ...
    @JsonProperty("classifications")
    public Builder
    withClassifications(final @Nullable List<ClassificationLabel> value) {
    ...
    public ChunkMetadata build() {
      return new ChunkMetadata(byteStart, byteEnd, tokenCount, chunkIndex,
                               totalChunks, firstPage, lastPage, headingContext,
                               headingPath, imageIndices, nodeIds, pageSpans,
                               classifications);
    }
  }
  // CPD-ON
