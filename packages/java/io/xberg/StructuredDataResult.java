...
// alef:hash:2112b4e3203b6112396db377f00039c5c615eb53a8bdb556f950ef050d73f756
...
public record
StructuredDataResult(@JsonProperty("content") String content,
  ...
  public static final class Builder {
    ...
    @JsonProperty("text_fields") private List<String> textFields = List.of();
    ...
    /**
     * Constructs a StructuredDataResult instance from the builder's current
     * state.
     */
    public StructuredDataResult build() {
      return new StructuredDataResult(content, format, metadata, textFields,
                                      value, flattened);
    }
  }
  // CPD-ON
