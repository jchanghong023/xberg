...
// alef:hash:9509665576d50f127b0d71b0186334c485524ada1dd1980c8baff03f183a5eb3
...
public record PostProcessorConfig(
    ...
    @Nullable @JsonProperty("enabled_processors")
    List<String> enabledProcessors,
    @Nullable @JsonProperty("disabled_processors")
    List<String> disabledProcessors,
  ...
  public static final class Builder {
    ...
    @JsonProperty("enabled_set") @Nullable private List<String> enabledSet;
    @JsonProperty("disabled_set") @Nullable private List<String> disabledSet;
    ...
    /**
     * Constructs a PostProcessorConfig instance from the builder's current
     * state.
     */
    public PostProcessorConfig build() {
      return new PostProcessorConfig(enabled, enabledProcessors,
                                     disabledProcessors, enabledSet,
                                     disabledSet);
    }
  }
  // CPD-ON
