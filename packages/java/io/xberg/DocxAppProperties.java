...
// alef:hash:2579c8891d48d15091f5873c956882032321caa658109caaae267d03df89f1ca
...
public record DocxAppProperties(
    ...
    @Nullable @JsonProperty("characters_with_spaces")
  ...
  public static final class Builder {
    ...
    /**
     * Constructs a DocxAppProperties instance from the builder's current
     * state.
     */
    public DocxAppProperties build() {
      return new DocxAppProperties(
          application, appVersion, template, totalTime, pages, words,
          characters, charactersWithSpaces, lines, paragraphs, company,
          docSecurity, scaleCrop, linksUpToDate, sharedDoc, hyperlinksChanged);
    }
  }
  // CPD-ON
}
