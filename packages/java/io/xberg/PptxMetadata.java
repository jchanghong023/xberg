...
// alef:hash:9de8f8d599f7ce16d2aa881079a843e8dce1fee9a3201414200c4fc9c0780730
...
public record
PptxMetadata(@JsonProperty("slide_count") int slideCount,
  ...
  public static final class Builder {
    ...
    @JsonProperty("slide_count") private int slideCount;
    @JsonProperty("slide_names") private List<String> slideNames = List.of();
    @JsonProperty("image_count") @Nullable private Integer imageCount;
    @JsonProperty("table_count") @Nullable private Integer tableCount;
