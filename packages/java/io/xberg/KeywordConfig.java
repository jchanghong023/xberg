...
// alef:hash:d29c1f4f850e3553d37a68577c7fbc46523f78a47932d2dac609d538df8231f3
...
public record
KeywordConfig(@Nullable @JsonProperty("algorithm") KeywordAlgorithm algorithm,
  ...
  public static final class Builder {
    ...
    @JsonProperty("max_keywords") @Nullable private Long maxKeywords;
    @JsonProperty("min_score") @Nullable private Float minScore;
    @JsonProperty("ngram_range") @Nullable private NgramRange ngramRange;
    @Nullable private String language;
    @JsonProperty("yake_params") @Nullable private YakeParams yakeParams;
    @JsonProperty("rake_params") @Nullable private RakeParams rakeParams;
    ...
    public KeywordConfig build() {
      return new KeywordConfig(algorithm, maxKeywords, minScore, ngramRange,
                               language, yakeParams, rakeParams);
    }
  }
  // CPD-ON
}
