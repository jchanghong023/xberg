...
// alef:hash:dc936af6655b3d281aa98797a4a5f4b77a5edd69b155edbffa41de724bad2533
...
@JsonSubTypes({
  ...
  , @JsonSubTypes.Type(value = AnnotationKind.Italic.class, name = "italic"),
      ...
      @JsonSubTypes.Type(value = AnnotationKind.FontSize.class,
                         name = "font_size"),
...
public sealed interface AnnotationKind {
   ...
   */
  record FontSize(@JsonProperty("value") String value)
      implements AnnotationKind {}
