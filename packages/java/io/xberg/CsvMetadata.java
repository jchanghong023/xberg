...
// alef:hash:bd84a9b1e1f2246011b3a36371f45a41caf6ae4c636879aa8721ce7aeab9d00a
...
public record
CsvMetadata(@JsonProperty("row_count") int rowCount,
  ...
  public static final class Builder {
    ...
    @JsonProperty("column_count") private int columnCount;
    @Nullable private String delimiter;
    @JsonProperty("has_header") private boolean hasHeader;
    @JsonProperty("column_types") @Nullable private List<String> columnTypes;
    ...
    public CsvMetadata build() {
      return new CsvMetadata(rowCount, columnCount, delimiter, hasHeader,
                             columnTypes);
    }
  }
  // CPD-ON
