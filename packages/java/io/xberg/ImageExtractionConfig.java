...
// alef:hash:82d5e7cd333fc0859826f29c6681546392c25d4830508ee7664f10f1008bd4be
...
public record ImageExtractionConfig(
  ...
  public ImageExtractionConfig {
    ...
    if (injectPlaceholders == null) {
      injectPlaceholders = true;
    }
    if (autoAdjustDpi == null) {
      autoAdjustDpi = true;
    }
    if (minDpi == null) {
      minDpi = 72;
  ...
  public static final class Builder {
    ...
    @JsonProperty("target_dpi") @Nullable private Integer targetDpi;
    ...
    @JsonProperty("auto_adjust_dpi") @Nullable private Boolean autoAdjustDpi;
    @JsonProperty("min_dpi") @Nullable private Integer minDpi;
    @JsonProperty("max_dpi") @Nullable private Integer maxDpi;
    @JsonProperty("max_images_per_page")
    @Nullable
    private Integer maxImagesPerPage;
    @Nullable private Boolean classify;
    @JsonProperty("include_page_rasters")
    @Nullable
    private Boolean includePageRasters;
    @JsonProperty("run_ocr_on_images") @Nullable private Boolean runOcrOnImages;
    @JsonProperty("ocr_text_only") @Nullable private Boolean ocrTextOnly;
    @JsonProperty("append_ocr_text") @Nullable private Boolean appendOcrText;
    @JsonProperty("output_format")
    @Nullable
    private ImageOutputFormat outputFormat = new ImageOutputFormat.Native();
    @Nullable private SvgOptions svg;
    @JsonProperty("include_data_base64")
    @Nullable
    private Boolean includeDataBase64;
    ...
    /**
     * Constructs a ImageExtractionConfig instance from the builder's current
     * state.
     */
    public ImageExtractionConfig build() {
      return new ImageExtractionConfig(
          extractImages, targetDpi, maxImageDimension, injectPlaceholders,
          autoAdjustDpi, minDpi, maxDpi, maxImagesPerPage, classify,
          includePageRasters, runOcrOnImages, ocrTextOnly, appendOcrText,
          outputFormat, svg, includeDataBase64);
    }
  }
  // CPD-ON
}
