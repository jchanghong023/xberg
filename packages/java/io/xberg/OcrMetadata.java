...
// alef:hash:67ba8c516a23f18252bee3c6b442bcc070e5811335a207f04f971da52e211f4f
...
public record
OcrMetadata(@JsonProperty("language") String language,
  ...
  public static final class Builder {
    ...
    @JsonProperty("table_count") private int tableCount;
    @JsonProperty("table_rows") @Nullable private Integer tableRows;
    @JsonProperty("table_cols") @Nullable private Integer tableCols;
    ...
    public OcrMetadata build() {
      return new OcrMetadata(language, psm, outputFormat, tableCount, tableRows,
                             tableCols);
    }
  }
  // CPD-ON
