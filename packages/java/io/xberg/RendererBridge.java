...
// alef:hash:3a1d9cabde31238129aa252b455f41757955652e467e6cbf55dbd723ee7e84e3
...
public final class RendererBridge implements AutoCloseable {
  ...
  private static final System.Logger LOGGER =
      System.getLogger(RendererBridge.class.getName());
  ...
  private void initStubRenderResult(long offset)
      throws ReflectiveOperationException {
    var stubRenderResult = LINKER.upcallStub(
        LOOKUP.bind(this, "handleRenderResult",
  ...
  private int handleRenderResult(MemorySegment userData,
                                 MemorySegment result_in,
  ...
  public static void registerRenderer(final IRenderer impl) throws Exception {
    ...
    try {
      try (var nameArena = Arena.ofShared()) {
        ...
        int rc = (int)(long)NativeLib.XBERG_REGISTER_RENDERER.invoke(
  ...
  public static void unregisterRenderer(String name) throws Exception {
    try {
      try (var nameArena = Arena.ofShared()) {
        ...
        MemorySegment outErr = nameArena.allocate(ValueLayout.ADDRESS);
        int rc = (int)(long)NativeLib.XBERG_UNREGISTER_RENDERER.invoke(nameCs,
                                                                       outErr);
        if (rc != 0) {
          MemorySegment errPtr = outErr.get(ValueLayout.ADDRESS, 0);
          String msg = errPtr.equals(MemorySegment.NULL)
