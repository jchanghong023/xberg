...
// alef:hash:e46fee44c5613853f67d408a5c52237033c58fbf5531a362318f094d72f0fcfb
...
public final class ValidatorBridge implements AutoCloseable {
  ...
  private static final System.Logger LOGGER =
      System.getLogger(ValidatorBridge.class.getName());
  ...
  // C vtable: 9 fields (4 plugin methods + 3 trait methods + free_string +
  // free_user_data)
  ...
  private void initStubValidate(long offset)
      throws ReflectiveOperationException {
  ...
  private void initStubShouldValidate(long offset)
      throws ReflectiveOperationException {
  ...
  private int handleValidate(MemorySegment userData, MemorySegment result_in,
  ...
  private long handleShouldValidate(MemorySegment userData,
  ...
  public static void registerValidator(final IValidator impl) throws Exception {
    ...
    try {
      try (var nameArena = Arena.ofShared()) {
        ...
        int rc = (int)(long)NativeLib.XBERG_REGISTER_VALIDATOR.invoke(
  ...
  public static void unregisterValidator(String name) throws Exception {
    try {
      try (var nameArena = Arena.ofShared()) {
        ...
        MemorySegment outErr = nameArena.allocate(ValueLayout.ADDRESS);
        int rc = (int)(long)NativeLib.XBERG_UNREGISTER_VALIDATOR.invoke(nameCs,
                                                                        outErr);
        if (rc != 0) {
          MemorySegment errPtr = outErr.get(ValueLayout.ADDRESS, 0);
          String msg = errPtr.equals(MemorySegment.NULL)
