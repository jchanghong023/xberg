...
// alef:hash:994d566cbd6eca681e165c4d2a999ae97d94947db839ba800dce4c7253c28bb7
...
public record TreeSitterProcessConfig(
  ...
  public static final class Builder {
    ...
    @JsonProperty("data_extraction") @Nullable private Boolean dataExtraction;
    @JsonProperty("chunk_max_size") @Nullable private Long chunkMaxSize;
    @JsonProperty("content_mode")
    @Nullable
    private CodeContentMode contentMode = CodeContentMode.CHUNKS;
    ...
    /**
     * Constructs a TreeSitterProcessConfig instance from the builder's current
     * state.
     */
    public TreeSitterProcessConfig build() {
      return new TreeSitterProcessConfig(
          ...
          diagnostics, dataExtraction, chunkMaxSize, contentMode);
    }
  }
  // CPD-ON
}
