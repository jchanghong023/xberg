...
// alef:hash:2758d880f8ebffba685247ec83131c1fc1d0e0ee7691f55c1e8ba3309283a509
...
public record ExtractionDiff(
  ...
  public static final class Builder {
    ...
    @JsonProperty("tables_added") private List<Table> tablesAdded = List.of();
    ...
    @JsonProperty("metadata_changed") private Object metadataChanged;
    @JsonProperty("embedded_changes") private EmbeddedChanges embeddedChanges;
    ...
    public ExtractionDiff build() {
      return new ExtractionDiff(contentDiff, tablesAdded, tablesRemoved,
                                tablesChanged, metadataChanged,
                                embeddedChanges);
    }
  }
  // CPD-ON
