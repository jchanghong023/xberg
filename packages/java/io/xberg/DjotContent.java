...
// alef:hash:c1b9e5cb82ffa0741bd9c8bc4762cd4e39896b28c6b4cfe671f070a8e802de1e
...
public record
DjotContent(@JsonProperty("plain_text") String plainText,
  ...
  public static final class Builder {
    ...
    public Builder withAttributes(final
                                  @Nullable List<DjotAttributeGroup> value) {
    ...
    public DjotContent build() {
      return new DjotContent(plainText, blocks, metadata, tables, images, links,
