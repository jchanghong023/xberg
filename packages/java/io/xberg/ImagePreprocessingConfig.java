...
// alef:hash:19bfe9339a6caf7beb022d6691af06f1ae18205228383f5ec06e6b9535411470
...
public record ImagePreprocessingConfig(
    ...
    @JsonProperty("normalize_shaded_rows") boolean normalizeShadedRows) {
  ...
  public static final class Builder {
    ...
    @JsonProperty("normalize_shaded_rows") private boolean normalizeShadedRows;
    ...
    /** Sets the normalizeShadedRows field. */
    @JsonProperty("normalize_shaded_rows")
    public Builder withNormalizeShadedRows(final boolean value) {
      this.normalizeShadedRows = value;
      return this;
    }
    ...
    public ImagePreprocessingConfig build() {
      return new ImagePreprocessingConfig(
          targetDpi, autoRotate, deskew, denoise, contrastEnhance,
          binarizationMethod, invertColors, normalizeShadedRows);
    }
  }
  // CPD-ON
}
