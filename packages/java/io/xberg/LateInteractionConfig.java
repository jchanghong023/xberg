...
// alef:hash:c63e4297d63773841d545e6dfb5e76503d592218e704916c8ed6f39736b59238
...
public record LateInteractionConfig(
    ...
    public LateInteractionConfig{
        if (batchSize == null) { batchSize = 16L; }
        if (maxLength == null) { maxLength = 512L; }
        if (queryMaxLength == null) { queryMaxLength = 32L; }
    }
