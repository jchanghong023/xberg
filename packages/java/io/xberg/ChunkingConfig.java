...
// alef:hash:ca226b408486c7cbfc9dd190b58cc353629f73c3aabccc5925ad149998d1a4be
...
public record ChunkingConfig(
    ...
    @Nullable @JsonProperty("sparse_embedding")
    SparseEmbeddingConfig sparseEmbedding,
    @Nullable @JsonProperty("late_interaction")
    LateInteractionConfig lateInteraction,
  ...
  public static final class Builder {
    ...
    @JsonProperty("max_chars") @Nullable private Long maxCharacters;
    @JsonProperty("max_overlap") @Nullable private Long overlap;
    @Nullable private Boolean trim;
    @JsonProperty("chunker_type")
    @Nullable
    private ChunkerType chunkerType = ChunkerType.TEXT;
    ...
    @Nullable
    private LateInteractionConfig lateInteraction;
    @Nullable private String preset;
    @Nullable private ChunkSizing sizing = new ChunkSizing.Characters();
    @JsonProperty("topic_threshold") @Nullable private Float topicThreshold;
    @JsonProperty("table_chunking")
    @Nullable
    private TableChunkingMode tableChunking = TableChunkingMode.SPLIT;
    ...
    @JsonProperty("sparse_embedding")
    public Builder withSparseEmbedding(final
                                       @Nullable SparseEmbeddingConfig value) {
    ...
    @JsonProperty("late_interaction")
    public Builder withLateInteraction(final
                                       @Nullable LateInteractionConfig value) {
    ...
    public ChunkingConfig build() {
      return new ChunkingConfig(maxCharacters, overlap, trim, chunkerType,
                                embedding, sparseEmbedding, lateInteraction,
                                preset, sizing, topicThreshold, tableChunking);
    }
  }
  // CPD-ON
}
