...
// alef:hash:29fdea658f69e35241ad5e0237ccf97500fd5ad65d1ed1ffa98b2438eb2f8d1f
...
public record
EpubMetadata(@Nullable @JsonProperty("coverage") String coverage,
  ...
  public static final class Builder {
    ...
    @JsonProperty("dc_format") @Nullable private String dcFormat;
    @Nullable private String relation;
    @Nullable private String source;
    @JsonProperty("dc_type") @Nullable private String dcType;
    @JsonProperty("cover_image") @Nullable private String coverImage;
    ...
    public EpubMetadata build() {
      return new EpubMetadata(coverage, dcFormat, relation, source, dcType,
                              coverImage);
    }
  }
  // CPD-ON
