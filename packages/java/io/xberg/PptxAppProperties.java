...
// alef:hash:bf19ee64231e309538befda5d56c3c9c4eb53ae339e2ae3070060c2ec17d40c9
...
public record PptxAppProperties(
  ...
  public static final class Builder {
    ...
    @JsonProperty("app_version") @Nullable private String appVersion;
    @JsonProperty("total_time") @Nullable private Integer totalTime;
    @Nullable private String company;
    @JsonProperty("doc_security") @Nullable private Integer docSecurity;
    @JsonProperty("scale_crop") @Nullable private Boolean scaleCrop;
    @JsonProperty("links_up_to_date") @Nullable private Boolean linksUpToDate;
    @JsonProperty("shared_doc") @Nullable private Boolean sharedDoc;
    ...
    @JsonProperty("hidden_slides") @Nullable private Integer hiddenSlides;
    @JsonProperty("multimedia_clips") @Nullable private Integer multimediaClips;
    @JsonProperty("presentation_format")
    @Nullable
    private String presentationFormat;
    @JsonProperty("slide_titles") private List<String> slideTitles = List.of();
    ...
    /**
     * Constructs a PptxAppProperties instance from the builder's current
     * state.
     */
    public PptxAppProperties build() {
      return new PptxAppProperties(
          application, appVersion, totalTime, company, docSecurity, scaleCrop,
          linksUpToDate, sharedDoc, hyperlinksChanged, slides, notes,
          hiddenSlides, multimediaClips, presentationFormat, slideTitles);
    }
  }
  // CPD-ON
}
