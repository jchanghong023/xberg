...
// alef:hash:500647e26ce550dcc3662d9146c1dac88fd12e8004d5979820e5a9905cf32f99
...
public record PptxExtractionResult(
  ...
  public static final class Builder {
    ...
    @JsonProperty("slide_count") private long slideCount;
    @JsonProperty("image_count") private long imageCount;
    @JsonProperty("table_count") private long tableCount;
    ...
    public Builder withHyperlinks(final
                                  @Nullable List<PresentationHyperlink> value) {
    ...
    @JsonProperty("office_metadata")
    public Builder withOfficeMetadata(final
    ...
    /**
     * Constructs a PptxExtractionResult instance from the builder's current
     * state.
     */
    public PptxExtractionResult build() {
      return new PptxExtractionResult(content, metadata, slideCount, imageCount,
                                      tableCount, images, pageStructure,
                                      pageContents, document, hyperlinks,
                                      officeMetadata, revisions);
    }
  }
  // CPD-ON
}
