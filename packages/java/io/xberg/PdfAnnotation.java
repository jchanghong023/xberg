...
// alef:hash:d72672d58435b47560d6066b5ddfd3ac60d4d55330d083216b21911b55ad6af8
...
public record PdfAnnotation(
  ...
  public static final class Builder {
    ...
    @JsonProperty("annotation_type") private PdfAnnotationType annotationType;
    ...
    @JsonProperty("quad_points") @Nullable private List<BoundingBox> quadPoints;
    @JsonProperty("marked_text") @Nullable private String markedText;
    ...
    public PdfAnnotation build() {
      return new PdfAnnotation(annotationType, content, pageNumber, boundingBox,
                               author, modified, color, subject, quadPoints,
                               markedText);
    }
  }
  // CPD-ON
