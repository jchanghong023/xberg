...
// alef:hash:09139eee8092a977ff7db849a4f6f207ad49f71c2bb7e155bbccceca24747b94
 ...
 * slices of this depending on the task. Xberg never executes cells — {@code
 * Outputs} and {@code Both} only surface outputs already stored in the {@code
 * .ipynb}.
 *
...
public enum JupyterCellRendering {
  ...
  JupyterCellRendering(final String value) { this.value = value; }
  ...
  public static JupyterCellRendering fromValue(final String value) {
    ...
    throw new IllegalArgumentException("Unknown JupyterCellRendering value: " +
                                       value);
  }
