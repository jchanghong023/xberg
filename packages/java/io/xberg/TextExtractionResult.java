...
// alef:hash:dfdbdf890b327c5ddc2e7d8916125a9de286da304eeff4493634c166130c1b83
...
public record TextExtractionResult(
  ...
  public static final class Builder {
    ...
    @JsonProperty("line_count") private long lineCount;
    @JsonProperty("word_count") private long wordCount;
    @JsonProperty("character_count") private long characterCount;
    ...
    /**
     * Constructs a TextExtractionResult instance from the builder's current
     * state.
     */
    public TextExtractionResult build() {
      return new TextExtractionResult(content, lineCount, wordCount,
                                      characterCount, headers, links,
                                      codeBlocks);
    }
  }
  // CPD-ON
