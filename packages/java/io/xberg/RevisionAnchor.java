...
// alef:hash:3301d7a1fdab60cdefae9037b80665f34643247871bb3eb2c6c316c470372745
...
@JsonSubTypes({
  ...
  ,
      @JsonSubTypes.Type(value = RevisionAnchor.TableCell.class,
                         name = "table_cell"),
...
public sealed interface RevisionAnchor {
   ...
   */
  record Paragraph(@JsonProperty("index") long index)
      implements RevisionAnchor {}

  /**
   * Cell inside a table.
   */
  record TableCell(@JsonProperty("row") long row, @JsonProperty("col") long col,
   ...
   */
  record Sheet(@JsonProperty("index") long index,
