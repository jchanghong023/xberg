...
// alef:hash:b83aa7ea53380b8311377533140da1afc5e73c212a74812b2f9bca4137a3df03
...
public final class PostProcessorAdapter implements IPostProcessor {
  ...
  public PostProcessorAdapter(IPostProcessor impl) { this.impl = impl; }
  ...
  @Override
  public boolean should_process(ExtractedDocument _result,
                                ExtractionConfig _config) throws Exception {
    return impl.should_process(_result, _config);
  }

  @Override
  public long estimated_duration_ms(ExtractedDocument _result)
      throws Exception {
