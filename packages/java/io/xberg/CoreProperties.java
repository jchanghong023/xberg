...
// alef:hash:5b5cb28f1617ddb1707cd64b1f2df62a09f2cba53fc88bac0f51eb4230d10d49
...
public record CoreProperties(
  ...
  public static final class Builder {
    ...
    @JsonProperty("last_modified_by") @Nullable private String lastModifiedBy;
    @Nullable private String revision;
    @Nullable private String created;
    @Nullable private String modified;
    @Nullable private String category;
    @JsonProperty("content_status") @Nullable private String contentStatus;
    @Nullable private String language;
    @Nullable private String identifier;
    @Nullable private String version;
    @JsonProperty("last_printed") @Nullable private String lastPrinted;
    ...
    public CoreProperties build() {
      return new CoreProperties(title, subject, creator, keywords, description,
                                lastModifiedBy, revision, created, modified,
                                category, contentStatus, language, identifier,
                                version, lastPrinted);
    }
  }
  // CPD-ON
