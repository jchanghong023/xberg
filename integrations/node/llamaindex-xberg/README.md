...
text, tables, and rich metadata from 107 formats — with optional OCR for scans and images.
...
const reader = new XbergReader({ extractionConfig: { chunking: { maxCharacters: 1000, overlap: 200 } } });
