...
// alef:hash:880b53f6958f8dde2b8ccc0356f6135b55458a379e7a473696987e1af91b70ad
...
final class Xberg
{
    ...
    public static function classifyChunksOwned(
        ...
        return \Xberg\XbergApi::classifyChunksOwned($result, $config); // delegate to native extension class
    }
     ...
     * cache.
     *
     * @return array<OcrBackendCapabilities>
     * @throws \Xberg\XbergException
     */
    public static function listOcrBackendCapabilities(): array
    {
        return \Xberg\XbergApi::listOcrBackendCapabilities(); // delegate to native extension class
    }
    ...
    {
        return \Xberg\XbergApi::ocrBackendSupportsLanguage($backend, $language); // delegate to native extension class
    }
