...
#[allow(clippy::box_collection)] // Intentional: Boxing reduces enum from 112 to 40 bytes ~keep
pub enum Operator {
    ...
    // PDF Spec: ISO 32000-1:2008, Section 8.9.7 - Inline Images ~keep
    ...
    // PDF Spec: ISO 32000-1:2008, Section 14.6 - Marked Content ~keep
...
impl Operator {
    ...
    ///
    /// ```ignore
    /// use xberg_native_pdf::content::operators::Operator;
...
mod tests {
    ...
    fn test_operator_enum_size() {
        ...
        // Enum: 32 (payload) + 8 (discriminant + alignment) = 40 bytes (was 112) ~keep
