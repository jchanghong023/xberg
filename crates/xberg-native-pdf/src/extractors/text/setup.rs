//! Construction, configuration, and per-page state setters.
//!
...
impl<'doc> TextExtractor<'doc> {
    ...
    pub(super) fn set_cached_current_font(&mut self, font: Option<Arc<FontInfo>>) {
