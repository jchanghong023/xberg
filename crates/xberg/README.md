...
<!-- alef:hash:69882ce1a43542aacc4b2ef0f2d68e160c646a94a0ddf718edc734651db29a35 -->
...
```toml
[dependencies]
xberg = { version = "1.2.8", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.2.8", features = ["full"] }
xberg = { version = "1.2.8", features = ["server"] }
xberg = { version = "1.2.8", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.2.8", features = ["pdf"] }
```
