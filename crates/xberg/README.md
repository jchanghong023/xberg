...
<!-- alef:hash:92708ddb158af73bb85c98375506e796e341a430ddb4cf8d7b282fa45b17f353 -->
...
```toml
[dependencies]
xberg = { version = "1.2.7", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.2.7", features = ["full"] }
xberg = { version = "1.2.7", features = ["server"] }
xberg = { version = "1.2.7", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.2.7", features = ["pdf"] }
```
