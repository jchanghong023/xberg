...
<!-- alef:hash:2377f35c01701fd6bf9a78c4d259101cb665c0f28b757857edccfe1b334c0e2c -->
...
```toml
[dependencies]
xberg = { version = "1.2.6", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.2.6", features = ["full"] }
xberg = { version = "1.2.6", features = ["server"] }
xberg = { version = "1.2.6", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.2.6", features = ["pdf"] }
```
