...
<!-- alef:hash:b1d99cb5fde43aa53e4788f284226498bbc8e882038dca688d977e41543727bf -->
...
```toml
[dependencies]
xberg = { version = "1.1.3", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.1.3", features = ["full"] }
xberg = { version = "1.1.3", features = ["server"] }
xberg = { version = "1.1.3", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.1.3", features = ["pdf"] }
```
