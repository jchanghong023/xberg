...
<!-- alef:hash:3c9e1d81b52591fc1e26b8ec967ac8ff8cf585e269b0aca1d659df0011d6e5e5 -->
...
```toml
[dependencies]
xberg = { version = "1.2.5", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.2.5", features = ["full"] }
xberg = { version = "1.2.5", features = ["server"] }
xberg = { version = "1.2.5", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.2.5", features = ["pdf"] }
```
