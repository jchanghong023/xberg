...
<!-- alef:hash:a8678b041f226f55f82bc96fae368742d3b04e2eb40a6d13db467aa87a31b5e0 -->
...
```toml
[dependencies]
xberg = { version = "1.2.9", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.2.9", features = ["full"] }
xberg = { version = "1.2.9", features = ["server"] }
xberg = { version = "1.2.9", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.2.9", features = ["pdf"] }
```
