...
<!-- alef:hash:f55056a9c2e03223da797de93b96d4f4040338e130ea89dff7dd0fafc654b9ac -->
...
```toml
[dependencies]
xberg = { version = "1.2.1", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.2.1", features = ["full"] }
xberg = { version = "1.2.1", features = ["server"] }
xberg = { version = "1.2.1", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.2.1", features = ["pdf"] }
```
