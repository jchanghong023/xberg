...
<!-- alef:hash:69828cbf73764bc36539cc1b277a97cc7ccbe38d8185448c12f948d97e33037a -->
...
```toml
[dependencies]
xberg = { version = "1.3.0", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.3.0", features = ["full"] }
xberg = { version = "1.3.0", features = ["server"] }
xberg = { version = "1.3.0", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.3.0", features = ["pdf"] }
```
